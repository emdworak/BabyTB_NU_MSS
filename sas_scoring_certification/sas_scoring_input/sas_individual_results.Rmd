...
subtitle: "Individualized Results"
...
## Load in the data 
load(file = "data/sas_results_to_print.rda")
```
...
for(i in 1:length(pull_names)) {
  ...
  pdf_create <- paste0("~/Desktop/MSS/BabyTB/BabyTB_Github/BabyTB_NU_MSS/sas_scoring_certification/sas_scoring_input/individual_reports/", pull_location, "/", name_space, "_sas_report.pdf")
