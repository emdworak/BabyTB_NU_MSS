...
### Video 1 ------ 
  sobY_v1_values <- eventReactive(input$sobY_v1_submit, {
    ...
    sobY_key_df <- data.frame(
      ...
      K_9_23_34 = c(1),
      K_9_23_35 = c(1),
      K_9_23_37 = c(1), # Updated on 2023/04/20
      K_9_23_38 = c(1),
      K_9_23_39 = c(1),
      K_9_23_40 = c(1),
      K_9_23_41 = c(0),
      ...
      K_9_23_56 = c(0),
      K_9_23_57 = c(0),
      K_9_23_66 = c(1), # Updated on 2023/04/20
      K_9_23_67 = c(1),
      K_9_23_68 = c(1),
      K_9_23_69 = c(0),
      K_9_23_70 = c(0),
...
### Video 2 ------
  sobY_v2_values <- eventReactive(input$sobY_v2_submit, {
    ...
    sobY_key_df <- data.frame(
      ...
      K_9_23_5 = c(0),
      K_9_23_6 = c(0),
      K_9_23_7 = c(1), # Updated on 2023/04/20
      K_9_23_9 = c(1),
      K_9_23_10 = c(1),
      K_9_23_11 = c(1),
      K_9_23_12 = c(0),
      ...
      K_9_23_31 = c(0),
      K_9_23_32 = c(1),
      K_9_23_33 = c(0), # Updated on 2023/04/20
      K_9_23_34 = c(0),
      K_9_23_35 = c(1),
      K_9_23_37 = c(1),
      K_9_23_38 = c(1),
      ...
      K_9_23_53 = c(0),
      K_9_23_54 = c(0),
      K_9_23_55 = c(1), # Updated on 2023/04/20
      K_9_23_56 = c(1),
      K_9_23_57 = c(0),
      K_9_23_66 = c(0),
      K_9_23_67 = c(1),
...
## Social Observational (older) data ------
  ...
  sobO_v1_values <- eventReactive(input$sobO_v1_submit, {
    ...
    sobO_key_df <- data.frame(
      ...
      K_24_48_27 = c(1),
      K_24_48_28 = c(0),
      K_24_48_29 = c(1), # Updated on 2023/04/20
      K_24_48_30 = c(1),
      K_24_48_31 = c(1)
    )
  ...
  sobO_v2_values <- eventReactive(input$sobO_v2_submit, {
    ...
    sobO_key_df <- data.frame(
      ...
      K_24_48_11 = c(0),
      K_24_48_12 = c(0),
      K_24_48_13 = c(1), # Updated on 2023/04/20
      K_24_48_14 = c(1),
      K_24_48_15 = c(0),
      K_24_48_16 = c(0),
      K_24_48_17 = c(0),
  ...
  gug_v1_values <- eventReactive(input$gug_v1_submit, {
    ...
    gug_v1_combined <- bind_cols(gug_v1_data, gug_key_df) %>% 
      mutate(Score_gug_v1_back = ifelse(gug_v1_back == K_Back, 1, 0),
             ...
             Score_gug_v1_start = ifelse(between(gug_v1_start, K_Start - 0.0101, K_Start + 0.0101), 1,
                                         ifelse(gug_v1_start == K_Start - 0.02, 0.5,
                                                ifelse(gug_v1_start == K_Start + 0.02, 0.5, 0))),
             Score_gug_v1_end = ifelse(between(gug_v1_end, K_End - 0.0101, K_End + 0.0101), 1,
  ...
  gug_v2_values <- eventReactive(input$gug_v2_submit, {
    ...
    gug_v2_combined <- bind_cols(gug_v2_data, gug_key_df) %>% 
      mutate(Score_gug_v2_back = ifelse(gug_v2_back == K_Back, 1, 0),
             ...
             Score_gug_v2_start = ifelse(between(gug_v2_start, K_Start - 0.0101, K_Start + 0.0101), 1,
                                         ifelse(gug_v2_start == K_Start - 0.02, 0.5,
                                                ifelse(gug_v2_start == K_Start + 0.02, 0.5, 0))),
             Score_gug_v2_end = ifelse(between(gug_v2_end, K_End - 0.0101, K_End + 0.0101), 1,
...
## Reach to Eat data ------
  ...
  rte_v1_values <- eventReactive(input$rte_v1_submit, {
    ...
    rte_key_df <- data.frame(
      ...
      K_SpnThr_Move = c(2),
      K_SpnThr_Grasp = c(1),
      K_SpnThr_Thumb = c(2), # Updated on 2023/04/20
      ...
      K_SpnTel_Grasp = c(2),
      K_SpnTel_Thumb = c(2),
      K_SpnTel_Success = c(3), # Updated on 2023/04/20
      K_SpnThl_Purpose = c(4),
      K_SpnThl_Move = c(2),
      K_SpnThl_Grasp = c(2),
      K_SpnThl_Thumb = c(2),
      K_SpnThl_Success = c(3) # Updated on 2023/04/20
    )
...
## Sit and Stand data ------
  ...
  sas_v1_values <- eventReactive(input$sas_v1_submit, {
    ...
    sas_v1_combined <- cbind(sas_v1_data, sas_key_df) %>% 
      mutate(Score_sas_v1_usit_q1 = ifelse(sas_v1_usit_q1 == K_Usit_Q1, 
                                           1, 0),
             Score_sas_v1_usit_q2_start = ifelse(between(sas_v1_usit_q2_start, K_Usit_Q2_St - 0.0101, K_Usit_Q2_St + 0.0101), 1, 
                                                 ifelse(sas_v1_usit_q2_start == K_Usit_Q2_St - 0.02, 0.5,
                                                        ifelse(sas_v1_usit_q2_start == K_Usit_Q2_St + 0.02, 0.5, 0))),
             Score_sas_v1_usit_q2_end = ifelse(between(sas_v1_usit_q2_end, K_Usit_Q2_End - 0.0101, K_Usit_Q2_End + 0.0101), 1, 
  ...
  sas_v2_values <- eventReactive(input$sas_v2_submit, {
    ...
    sas_v2_combined <- cbind(sas_v2_data, sas_key_df) %>% 
      mutate(Score_sas_v2_std_q1 = ifelse(sas_v2_std_q1 == K_StD_Q1, 
                                          1, 0),
             Score_sas_v2_std_q2_start = ifelse(between(sas_v2_std_q2_start, K_StD_Q2_St - 0.0101, K_StD_Q2_St + 0.0101), 1, 
                                                ifelse(sas_v2_std_q2_start == K_StD_Q2_St - 0.02, 0.5,
                                                       ifelse(sas_v2_std_q2_start == K_StD_Q2_St + 0.02, 0.5, 0))),
             Score_sas_v2_std_q2_end = ifelse(between(sas_v2_std_q2_end, K_StD_Q2_End - 0.0101, K_StD_Q2_End + 0.0101), 1, 
             ...
             Score_sas_v2_std_q3 = ifelse(sas_v2_std_q3 == K_StD_Q3, 
                                          1, 0),
             Score_sas_v2_std_q4_start = ifelse(between(sas_v2_std_q4_start, K_StD_Q4_St - 0.0101, K_StD_Q4_St + 0.0101), 1, 
                                                ifelse(sas_v2_std_q4_start == K_StD_Q4_St - 0.02, 0.5,
                                                       ifelse(sas_v2_std_q4_start == K_StD_Q4_St + 0.02, 0.5, 0))),
             Score_sas_v2_std_q4_end = ifelse(between(sas_v2_std_q4_end, K_StD_Q4_End - 0.0101, K_StD_Q4_End + 0.0101), 1, 
    ...
    sas_v3_combined <- cbind(sas_v3_data, sas_key_df) %>% 
      mutate(Score_sas_v3_pts_q1 = ifelse(sas_v3_pts_q1 == K_PtS_Q1, 
             ...
             Score_sas_v3_usit_q1 = ifelse(sas_v3_usit_q1 == K_Usit_Q1, 
                                           1, 0),
             Score_sas_v3_usit_q2_start = ifelse(between(sas_v3_usit_q2_start, K_Usit_Q2_St - 0.0101, K_Usit_Q2_St + 0.0101), 1, 
                                                 ifelse(sas_v3_usit_q2_start == K_Usit_Q2_St - 0.02, 0.5,
                                                        ifelse(sas_v3_usit_q2_start == K_Usit_Q2_St + 0.02, 0.5, 0))),
             Score_sas_v3_usit_q2_end = ifelse(between(sas_v3_usit_q2_end, K_Usit_Q2_End - 0.0101, K_Usit_Q2_End + 0.0101), 1, 
  ...
  output$sas_v3_incorrect <- renderTable({
    ...
    return_sas_v3 <- sas_v3_data %>% 
      mutate(sas_v3_pts_q1 = factor(sas_v3_pts_q1, app_values_1_2,
                                    c("No", "Yes")),
             K_PtS_Q1 = factor(K_PtS_Q1, app_values_1_2,
                                    c("No", "Yes")),
  ...
  sas_v4_values <- eventReactive(input$sas_v4_submit, {
    ...
    sas_key_df <- data.frame(
      ...
      K_StD_Q2_End = c(.51),
      K_StD_Q3 = c(5),
      K_StD_Q4_St = c(2.00), # Updated on 2023/04/20
      K_StD_Q4_End = c(2.34)
    )
    ...
    sas_v4_combined <- cbind(sas_v4_data, sas_key_df) %>% 
      mutate(Score_sas_v4_std_q1 = ifelse(sas_v4_std_q1 == K_StD_Q1, 
                                          1, 0),
             Score_sas_v4_std_q2_start = ifelse(between(sas_v4_std_q2_start, K_StD_Q2_St - 0.0101, K_StD_Q2_St + 0.0101), 1, 
                                                ifelse(sas_v4_std_q2_start == K_StD_Q2_St - 0.02, 0.5,
                                                       ifelse(sas_v4_std_q2_start == K_StD_Q2_St + 0.02, 0.5, 0))),
             Score_sas_v4_std_q2_end = ifelse(between(sas_v4_std_q2_end, K_StD_Q2_End - 0.0101, K_StD_Q2_End + 0.0101), 1, 
             ...
             Score_sas_v4_std_q3 = ifelse(sas_v4_std_q3 == K_StD_Q3, 
                                          1, 0),
             Score_sas_v4_std_q4_start = ifelse(between(sas_v4_std_q4_start, K_StD_Q4_St - 0.0101, K_StD_Q4_St + 0.0101), 1, 
                                                ifelse(sas_v4_std_q4_start == K_StD_Q4_St - 0.02, 0.5,
                                                       ifelse(sas_v4_std_q4_start == K_StD_Q4_St + 0.02, 0.5, 0))),
             Score_sas_v4_std_q4_end = ifelse(between(sas_v4_std_q4_end, K_StD_Q4_End - 0.0101, K_StD_Q4_End + 0.0101), 1, 
