...
cert_df_app_v2$name[cert_df_app_v2$name == "Field, Rebecca"] <- "Field, Rebecca 2"
...
cert_df_app_v1v2 %>% 
  count(name, site) %>% 
  filter(name %in% c("Isbell (Weems), Christy", "Isbell- Weems", "Isbell- Weems, Christy", "Isbell-Weems", "Isbell-Weems, Christy", "Patricia Blasco",
                     "Avina", "Avina Sara", "Avina sara",
                     "stokes", "stokes monique", "stokes, monique", "stokes,monique",
                     "Mlynski, Nicole", "Mlynski,Nicole", "Nicole Mlynski", 
                     "Smith, Tudi", "smith, tudi", "smith, Tudi", "smith,tudi", "tudi", "tudi Smith",  "tudi smith", "smith,  tudi", 
                     "Karr, Reanna", "Karr",
                     "Martinez Marquez Flor", "Martinez marquez Flor",
                     "martinez marquez flor", "martinez Marquez flor",
                     "VanEss, Lisa", "Vaness, Lisa",
                     "JANA, PUJA", "JANA,PUJA",
                     "MUNESA, LUKE", "Munesa, Luke", "Luke Munesa",
                     "Aminah Askew", "Aminah askew",
                     "Adams Kyle", "Adams, Kyle",
                     "Sifuentes, Maci", "Maci Sifuentes",
                     "Samé, Alisha", "Same, Alisha",
                     "Martinez, Karina", "Martinez, Karina", "Martinez", "MARTINEZ,KARINA", "MARTINEZ, KARINA", 
                     "McGuire, Amy", "McGuire, McGuire",
    "Craog, Maggie", "Craig, Maggie",
                     "Virginia, Christman", "Christman, Virginia", "Christman, Virginia`",
                     "Lane Harlie", "Lane, Harlie", 
    "churchillda pratt", "pratt churchillda", "Pratt Churchillda", "Pratt, Churchillda", "Pratt, churchillda",
                     "Parman, Ben", "Parman. Ben", "Ben Parman",
                     "Bologno , Megan", "Bologno Megan", "Bologno, Megan", 
                     "Medina, Keila", "Medina, Keils",
                     "Simmons, Millennia", "Simmons,Millennia", "simmons,Millennia", "simmons,millennia",
                     "Stewart-Milton", "Stewart-Milton, Chelsea",
                     "Fletes. Fabiola", "Fletes, Fabiola",
                     "Ramirez,Rosario", "Ramirez, Rosario", 
                     "Skinner, Andrea", "Skinner, Andrea", "Andrea Skinner", "Skinner,  Andrea",
                     "Yilma, aden", "Yilma, Aden", "Yilma,aden",
                     "Oyer,Nick", "Oyer, Nick", 
                     "Becky, Baron", "Baron, Becky",
...
Fix the names:
```{r}
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Patricia Blasco"] <- "Blasco, Patricia"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Isbell (Weems), Christy"] <- "Isbell-Weems, Christy"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Isbell- Weems"] <- "Isbell-Weems, Christy"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Isbell- Weems, Christy"] <- "Isbell-Weems, Christy"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Isbell-Weems"] <- "Isbell-Weems, Christy"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Avina"] <- "Avina, Sara"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Avina Sara"] <- "Avina, Sara"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Avina sara"] <- "Avina, Sara"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Mlynski,Nicole"] <- "Mlynski, Nicole"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Nicole Mlynski"] <- "Mlynski, Nicole"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "stokes"] <- "Stokes, Monique"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "stokes monique"] <- "Stokes, Monique"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "stokes,monique"] <- "Stokes, Monique"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "stokes, monique"] <- "Stokes, Monique"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "smith,  tudi"] <- "Smith, Tudi"
...
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "tudi"] <- "Smith, Tudi"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "tudi Smith"] <- "Smith, Tudi"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "tudi smith"] <- "Smith, Tudi"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Karr"] <- "Karr, Reanna"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "martinez marquez flor"] <- "Martinez Marquez Flor"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "martinez Marquez flor"] <- "Martinez Marquez Flor"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Martinez marquez Flor"] <- "Martinez Marquez Flor"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Vaness, Lisa"] <- "VanEss, Lisa"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "JANA,PUJA"] <- "JANA, PUJA"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Luke Munesa"] <- "Munesa, Luke"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "MUNESA, LUKE"] <- "Munesa, Luke"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Aminah askew"] <- "Aminah Askew"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Adams Kyle"] <- "Adams, Kyle"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Maci Sifuentes"] <- "Sifuentes, Maci"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Same, Alisha"] <- "Samé, Alisha"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "MARTINEZ, KARINA"] <- "Martinez, Karina"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "MARTINEZ,KARINA"] <- "Martinez, Karina"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Martinez"] <- "Martinez, Karina"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "McGuire, McGuire"] <- "McGuire, Amy"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Craog, Maggie"] <- "Craig, Maggie"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Virginia, Christman"] <- "Christman, Virginia"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Christman, Virginia`"] <- "Christman, Virginia"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Lane Harlie"] <- "Lane, Harlie"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "churchillda pratt"] <- "Pratt, Churchillda"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "pratt churchillda"] <- "Pratt, Churchillda"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Pratt Churchillda"] <- "Pratt, Churchillda"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Pratt, churchillda"] <- "Pratt, Churchillda"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Bologno Megan"] <- "Bologno, Megan"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Bologno , Megan"] <- "Bologno, Megan"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Ben Parman"] <- "Parman, Ben"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Parman. Ben"] <- "Parman, Ben"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Medina, Keils"] <- "Medina, Keila"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "simmons,millennia"] <- "Simmons, Millennia"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "simmons,Millennia"] <- "Simmons, Millennia"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Simmons,Millennia"] <- "Simmons, Millennia"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Stewart-Milton"] <- "Stewart-Milton, Chelsea"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Fletes. Fabiola"] <- "Fletes, Fabiola"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Ramirez,Rosario"] <- "Ramirez, Rosario"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Skinner,  Andrea"] <- "Skinner, Andrea"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Skinner,Andrea"] <- "Skinner, Andrea"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Andrea Skinner"] <- "Skinner, Andrea"
...
## Fix the cases that required retests
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "sobY_v1"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "sobY_v2"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "gug_v1"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "gug_v2"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "sas_v1"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "sas_v2"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "sas_v3"] <- "Delete"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa" & cert_df_app_v1v2$task_id == "sas_v4"] <- "Delete"

# cert_df_app_v1v2 %>% 
#   filter(name %in% c("Delete"))

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "sobY_v1"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "sobY_v2"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "gug_v1"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "gug_v2"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "sas_v1"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "sas_v2"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "sas_v3"] <- "VanEss, Lisa"
cert_df_app_v1v2$name[cert_df_app_v1v2$name == "VanEss, Lisa 2" & cert_df_app_v1v2$task_id == "sas_v4"] <- "VanEss, Lisa"

cert_df_app_v1v2$name[cert_df_app_v1v2$name == "Stokes, Monique" & cert_df_app_v1v2$date > "2023-07-21"] <- "Stokes, Monique 2"
...
```{r}
cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Stokes, Monique 2"] <- "Phoenix, AZ"

cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Smith, Tudi"] <- "Minneapolis, MN"

cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Munesa, Luke"] <- "Philadelphia, PA"

cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Adams, Kyle"] <- "Philadelphia, PA"

cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Reid, Christopher"] <- "Baltimore, MD"

cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Skinner, Andrea"] <- "Nashville, TN"

cert_df_app_v1v2$site[cert_df_app_v1v2$name == "Martinez, Karina"] <- "Dallas, TX"
```
...
scored_cert_df <- bind_cols(cert_df_wide_full, all_keys) %>% 
  ...
  mutate(Score_gug_v1_back = ifelse(gug_v1_back == K_gug_v1_Back, 1, 0),
           ...
           Score_gug_v1_start = ifelse(between(gug_v1_start, K_gug_v1_Start - 0.0101, K_gug_v1_Start + 0.0101), 1,
                                       ifelse(gug_v1_start == K_gug_v1_Start - 0.02, 0.5,
                                              ifelse(gug_v1_start == K_gug_v1_Start + 0.02, 0.5, 0))),
           Score_gug_v1_end = ifelse(between(gug_v1_end, K_gug_v1_End - 0.0101, K_gug_v1_End + 0.0101), 1,
  ...
  mutate(Score_gug_v2_back = ifelse(gug_v2_back == K_gug_v2_Back, 1, 0),
           ...
           Score_gug_v2_start = ifelse(between(gug_v2_start, K_gug_v2_Start - 0.0101, K_gug_v2_Start + 0.0101), 1,
                                       ifelse(gug_v2_start == K_gug_v2_Start - 0.02, 0.5,
                                              ifelse(gug_v2_start == K_gug_v2_Start + 0.02, 0.5, 0))),
           Score_gug_v2_end = ifelse(between(gug_v2_end, K_gug_v2_End - 0.0101, K_gug_v2_End + 0.0101), 1,
    ...
    mutate(Score_sas_v1_usit_q1 = ifelse(sas_v1_usit_q1 == K_sas_v1_Usit_Q1, 
                                         1, 0),
           Score_sas_v1_usit_q2_start = ifelse(between(sas_v1_usit_q2_start, K_sas_v1_Usit_Q2_St - 0.0101, K_sas_v1_Usit_Q2_St + 0.0101), 1, 
                                               ifelse(sas_v1_usit_q2_start == K_sas_v1_Usit_Q2_St - 0.02, 0.5,
                                                      ifelse(sas_v1_usit_q2_start == K_sas_v1_Usit_Q2_St + 0.02, 0.5, 0))),
           Score_sas_v1_usit_q2_end = ifelse(between(sas_v1_usit_q2_end, K_sas_v1_Usit_Q2_End - 0.0101, K_sas_v1_Usit_Q2_End + 0.0101), 1, 
    ...
    mutate(Score_sas_v2_std_q1 = ifelse(sas_v2_std_q1 == K_sas_v2_StD_Q1, 
                                        1, 0),
           Score_sas_v2_std_q2_start = ifelse(between(sas_v2_std_q2_start, K_sas_v2_StD_Q2_St - 0.0101, K_sas_v2_StD_Q2_St + 0.0101), 1, 
                                              ifelse(sas_v2_std_q2_start == K_sas_v2_StD_Q2_St - 0.02, 0.5,
                                                     ifelse(sas_v2_std_q2_start == K_sas_v2_StD_Q2_St + 0.02, 0.5, 0))),
           Score_sas_v2_std_q2_end = ifelse(between(sas_v2_std_q2_end, K_sas_v2_StD_Q2_End - 0.0101, K_sas_v2_StD_Q2_End + 0.0101), 1, 
           ...
           Score_sas_v2_std_q3 = ifelse(sas_v2_std_q3 == K_sas_v2_StD_Q3, 
                                        1, 0),
           Score_sas_v2_std_q4_start = ifelse(between(sas_v2_std_q4_start, K_sas_v2_StD_Q4_St - 0.0101, K_sas_v2_StD_Q4_St + 0.0101), 1, 
                                              ifelse(sas_v2_std_q4_start == K_sas_v2_StD_Q4_St - 0.02, 0.5,
                                                     ifelse(sas_v2_std_q4_start == K_sas_v2_StD_Q4_St + 0.02, 0.5, 0))),
           Score_sas_v2_std_q4_end = ifelse(between(sas_v2_std_q4_end, K_sas_v2_StD_Q4_End - 0.0101, K_sas_v2_StD_Q4_End + 0.0101), 1, 
    ...
    mutate(Score_sas_v3_pts_q1 = ifelse(sas_v3_pts_q1 == K_sas_v3_PtS_Q1, 
           ...
           Score_sas_v3_usit_q1 = ifelse(sas_v3_usit_q1 == K_sas_v3_Usit_Q1, 
                                         1, 0),
           Score_sas_v3_usit_q2_start = ifelse(between(sas_v3_usit_q2_start, K_sas_v3_Usit_Q2_St - 0.0101, K_sas_v3_Usit_Q2_St + 0.0101), 1, 
                                               ifelse(sas_v3_usit_q2_start == K_sas_v3_Usit_Q2_St - 0.02, 0.5,
                                                      ifelse(sas_v3_usit_q2_start == K_sas_v3_Usit_Q2_St + 0.02, 0.5, 0))),
           Score_sas_v3_usit_q2_end = ifelse(between(sas_v3_usit_q2_end, K_sas_v3_Usit_Q2_End - 0.0101, K_sas_v3_Usit_Q2_End + 0.0101), 1, 
    ...
    mutate(Score_sas_v4_std_q1 = ifelse(sas_v4_std_q1 == K_sas_v4_StD_Q1, 
                                        1, 0),
           Score_sas_v4_std_q2_start = ifelse(between(sas_v4_std_q2_start, K_sas_v4_StD_Q2_St - 0.0101, K_sas_v4_StD_Q2_St + 0.0101), 1, 
                                              ifelse(sas_v4_std_q2_start == K_sas_v4_StD_Q2_St - 0.02, 0.5,
                                                     ifelse(sas_v4_std_q2_start == K_sas_v4_StD_Q2_St + 0.02, 0.5, 0))),
           Score_sas_v4_std_q2_end = ifelse(between(sas_v4_std_q2_end, K_sas_v4_StD_Q2_End - 0.0101, K_sas_v4_StD_Q2_End + 0.0101), 1, 
           ...
           Score_sas_v4_std_q3 = ifelse(sas_v4_std_q3 == K_sas_v4_StD_Q3, 
                                        1, 0),
           Score_sas_v4_std_q4_start = ifelse(between(sas_v4_std_q4_start, K_sas_v4_StD_Q4_St - 0.0101, K_sas_v4_StD_Q4_St + 0.0101), 1, 
                                              ifelse(sas_v4_std_q4_start == K_sas_v4_StD_Q4_St - 0.02, 0.5,
                                                     ifelse(sas_v4_std_q4_start == K_sas_v4_StD_Q4_St + 0.02, 0.5, 0))),
           Score_sas_v4_std_q4_end = ifelse(between(sas_v4_std_q4_end, K_sas_v4_StD_Q4_End - 0.0101, K_sas_v4_StD_Q4_End + 0.0101), 1, 
...
score_cert_factored <- score_cert_factored %>% 
    mutate(gug_v1_back = factor(gug_v1_back, app_values_0_2, c("No (didn’t try)", "No (tried but couldn’t)", "Yes")),
           K_gug_v1_Back = factor(K_gug_v1_Back, app_values_0_2, c("No (didn’t try)", "No (tried but couldn’t)", "Yes")),
  ...
  mutate(gug_v2_back = factor(gug_v2_back, app_values_0_2, c("No (didn’t try)", "No (tried but couldn’t)", "Yes")),
           K_gug_v2_Back = factor(K_gug_v2_Back, app_values_0_2, c("No (didn’t try)", "No (tried but couldn’t)", "Yes")),
  ...
  mutate(sas_v3_pts_q1 = factor(sas_v3_pts_q1, app_values_1_2,
                                  c("No", "Yes")),
         K_sas_v3_PtS_Q1  = factor(K_sas_v3_PtS_Q1, app_values_1_2,
                                  c("No", "Yes")),
...
# Extra code for printing tables
...
```{r, eval = FALSE}
original_examiners <- scored_cert_df %>%
  filter(name %in% c("Sashoyan, Maria", "Holland, Jennifer",
                     "LaFauci, Phil", "Martinez, Vanessa",
                     "Paternostro, Mercedes", "Rodriguez, Cynthia",
                     "Cipas, Kyle", "Lozano, Linda",
                     "Lane, Harlie", "Thury, Khari",
                     "Anderson, Josh", "Jenkins, Rebecca",
                     "Olson, Megan")) %>%
  select(name, site, starts_with("ScoreOverall")) %>% 
  pivot_longer(cols = ScoreOverall_sobY_v1:ScoreOverall_sas_v4,
               names_to = "names") %>% 
  mutate(names2 = str_remove(names, "\\_v\\d"),
         video = str_extract(names, "v\\d")) %>% 
  pivot_wider(id_cols = c("name", "site", "video"),
              names_from = names2,
              values_from = value) %>% 
  select(starts_with("ScoreOverall")) %>% 
  rename_with(stringr::str_replace, 
              pattern = "ScoreOverall\\_", replacement = "", 
              matches("ScoreOverall\\_")) %>%
  data.frame() %>% 
  describe(., d = 4) 

original_examiners <- cbind(test = rownames(original_examiners), original_examiners)

write_xlsx(original_examiners, "for_Miriam/original_examiners.xlsx")

secondary_examiners <- scored_cert_df %>%
  filter(name %nin% c("Sashoyan, Maria", "Holland, Jennifer",
                     "LaFauci, Phil", "Martinez, Vanessa",
                     "Paternostro, Mercedes", "Rodriguez, Cynthia",
                     "Cipas, Kyle", "Lozano, Linda",
                     "Lane, Harlie", "Thury, Khari",
...
secondary_examiners <- cbind(test = rownames(secondary_examiners), secondary_examiners)

write_xlsx(secondary_examiners, "for_Miriam/secondary_examiners.xlsx")

```

```{r, eval=FALSE}
cert_summary <- scored_cert_df %>%
  select(name, site, starts_with("ScoreOverall")) %>%
  rename_with(stringr::str_replace, 
              pattern = "ScoreOverall\\_", replacement = "", 
              matches("ScoreOverall\\_")) %>%
  group_by(name, site) %>% 
  mutate(sobY_avg = mean(c(sobY_v1, sobY_v2)),
         sobY_pass_fail = ifelse(sobY_avg >=.750, "Pass", "Fail"),
         sobO_avg = mean(c(sobO_v1, sobO_v2)),
         sobO_pass_fail = ifelse(sobO_avg >=.750, "Pass", "Fail"),
         gug_avg = mean(c(gug_v1, gug_v2)),
         gug_pass_fail = ifelse(gug_avg >=.750, "Pass", "Fail"),
         rte_avg = mean(c(rte_v1, rte_v2)),
         rte_pass_fail = ifelse(rte_avg >=.750, "Pass", "Fail"),
         sas_avg = mean(c(sas_v1, sas_v2, sas_v3, sas_v4)),
         sas_pass_fail = ifelse(sas_avg >=.750, "Pass", "Fail")
  ) %>% 
  select(name, site, 
         starts_with("sobY_v"), starts_with("sobY"),
         starts_with("sobO_v"), starts_with("sobO"),
         starts_with("gug_v"), starts_with("gug"),
         starts_with("rte_v"), starts_with("rte"),
         starts_with("sas_v"), starts_with("sas")
         ) %>% 
  data.frame() 

write_xlsx(cert_summary, "for_Miriam/20230613_cert_summary.xlsx")
```
