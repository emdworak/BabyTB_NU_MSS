...
cert_df_app_v2 <- read_xlsx("data/2023_BBTB_Cert_20230414.xlsx") %>% 
  janitor::clean_names() %>% 
  filter(name %nin% c("QA Testing", "QA Test", "TEST-MIRIAM")) %>% 
  filter(key == "Response") %>% 
...
This is not information that needs to be printed out in the report as it's over 200 rows long.
```{r, eval=FALSE}
cert_df_app_v1v2 %>% 
...
for(i in 1:length(pull_names)) {
  ...
  overall_df %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[1])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed")) %>% cat
...
# print(paste("Scores for ", pull_names[i]))
# print(kable(overall_df, "rst"))
# print(kable(item_df, "rst"))
...
item_list[[1]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[1])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
...
overall_list[[2]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[2])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))

item_list[[2]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[2])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
...
overall_list[[3]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[3])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))

item_list[[3]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[3])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
...
overall_list[[4]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[4])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))

item_list[[4]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[4])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
...
overall_list[[5]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[5])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))

item_list[[5]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[5])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
...
overall_list[[6]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[6])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))

item_list[[6]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[6])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
...
overall_list[[7]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Overall Scores for ", pull_names[7])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))

item_list[[7]] %>% 
  data.frame() %>% 
  kbl(caption = paste("Item Level Scores for ", pull_names[7])) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
                fixed_thead = TRUE)
